...
export function resolveAffiliate(pin) {
  ...
  return {
    ...
    email: typeof aff.email === 'string' ? aff.email : '',
    // NEW: gate discounts per affiliate
    allowDiscount: Boolean(aff.allowDiscount),

    bundleRate:
      typeof aff.bundleRate === 'number' ? aff.bundleRate : 0.7,
    ...
    fountainCommission:
      typeof aff.fountainCommission === 'number'
        ? aff.fountainCommission
        : 50,
  };
}
